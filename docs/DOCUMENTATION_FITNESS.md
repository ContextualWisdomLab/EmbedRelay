...
| Detailed ADR decision evidence | **PRESENT-CURRENT** | ADR-0001…0010 now record drivers, alternatives, failure/recovery, security/governance, verification, migration/rollback, and supersession. | Keep the machine-checkable ADR structure synchronized with every new/superseding decision. |
